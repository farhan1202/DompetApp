...
import 'package:mobile_pocket_app/app/modules/main/kategori/editKategori/controllers/edit_kategori_controller.dart';

class InputStatus extends GetView<EditKategoriController> {
        ...
        children: [
          ...
          Container(
            ...
            child: DropdownSearch<Datum>(
              ...
              hint: controller.data.statusId == "1" ? "Aktif" : "Tidak Aktif",
