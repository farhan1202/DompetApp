...
import 'package:mobile_pocket_app/app/modules/main/dompetKeluar/addDompetKeluar/controllers/add_dompet_keluar_controller.dart';

class InputKategori extends GetView<AddDompetKeluarController> {
  const InputKategori({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Container(
            ...
            child: DropdownSearch<Datum>(
              mode: Mode.MENU,
              onFind: (text) {
                var data = controller.getDataKategori();
                return data;
              },
              hint: "Kategori",
